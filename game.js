...
BasicGame.Game.prototype = {
  ...
  setupPlayerIcon: function() {
    ...
    var firstLifeIconX =
      this.game.width - 10 - BasicGame.PLAYER_EXTRA_LIVES * 30;
  ...
  setupText: function() {
    this.instructions = this.add.text(
      ...
      "Use Arrow Key to move, Press Z to fire\nTapping/clicking does both",
      ...
      shooter.rotation =
        this.physics.arcade.moveToXY(
          ...
          this.rnd.integerInRange(
            BasicGame.SHOOTER_MIN_VELOCITY,
            BasicGame.SHOOTER_MAX_VELOCITY
          )
        ) -
        Math.PI / 2;
